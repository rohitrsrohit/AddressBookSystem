...
public class AddressBook {
	    ...
	    public ArrayList<Main> addressBook = new ArrayList<>();

	    public AddressBook(String name) {
	        this.name = name;
	    }

	    public ArrayList<Main> getAddressBook() {
	        return addressBook;
	    }
