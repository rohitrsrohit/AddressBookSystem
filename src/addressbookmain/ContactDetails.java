...
public class ContactDetails {
    ...
    public void addDataToAddressBook() {
        ...
        do {
            ...
            do {
                ...
                Main contact = new Main(firstName, lastName, address, cityForMap, state, zipcode, phoneNumber, emailID);
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            switch (choice) {
                case 1:
                    new ContactDetails().addDataToAddressBook(); //Add Contact Details
                    break;
                case 2:
